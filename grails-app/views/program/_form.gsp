<%@ page import="rdmdt.Program" %>
			...
			<div class="${hasErrors(bean: programInstance, field: 'name', 'error')} ">
				<label for="name" class="control-label"><g:message code="program.name.label" default="Name" /></label>
				<div>
					<g:textField class="form-control" name="name" value="${programInstance?.name}"/>
