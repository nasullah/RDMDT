...
<body>
	...
	<section id="edit-familyHistoryType" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${familyHistoryTypeInstance?.id}" />
			<g:hiddenField name="version" value="${familyHistoryTypeInstance?.version}" />
