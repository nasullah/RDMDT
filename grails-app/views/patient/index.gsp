	...
	<table class="table table-bordered margin-top-medium">
		<thead>
			<tr>
				...
				<g:sortableColumn property="givenName" title="${message(code: 'patient.givenName.label', default: 'isProband')}" />
		...
		<g:each in="${patientInstanceList}" status="i" var="patientInstance">
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
				...
				<td><g:link action="show" id="${patientInstance.id}">${fieldValue(bean: patientInstance, field: "isProband")}</g:link></td>
