...
class FamilyMembersAffectedTypeController {
    ...
    def index(Integer max) {
        ...
        respond FamilyMembersAffectedType.list(params), model: [familyMembersAffectedTypeInstanceCount: FamilyMembersAffectedType.count()]
    }
    ...
    def show(FamilyMembersAffectedType familyMembersAffectedTypeInstance) {
        respond familyMembersAffectedTypeInstance
    }
