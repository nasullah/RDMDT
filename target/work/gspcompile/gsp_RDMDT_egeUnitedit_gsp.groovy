...
class gsp_RDMDT_egeUnitedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/egeUnit/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',7,['var':("entityName"),'value':(message(code: 'egeUnit.label', default: 'Age Unit'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('renderErrors','g',17,['bean':(egeUnitInstance),'as':("list")],-1)
printHtmlPart(6)
})
invokeTag('hasErrors','g',19,['bean':(egeUnitInstance)],2)
printHtmlPart(7)
createTagBody(2, {->
printHtmlPart(8)
invokeTag('hiddenField','g',22,['name':("id"),'value':(egeUnitInstance?.id)],-1)
printHtmlPart(8)
invokeTag('hiddenField','g',23,['name':("version"),'value':(egeUnitInstance?.version)],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1464182355817L
