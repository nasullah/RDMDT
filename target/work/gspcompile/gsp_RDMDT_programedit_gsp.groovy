...
class gsp_RDMDT_programedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('renderErrors','g',17,['bean':(programInstance),'as':("list")],-1)
printHtmlPart(6)
})
invokeTag('hasErrors','g',19,['bean':(programInstance)],2)
printHtmlPart(7)
createTagBody(2, {->
printHtmlPart(8)
invokeTag('hiddenField','g',22,['name':("id"),'value':(programInstance?.id)],-1)
printHtmlPart(8)
invokeTag('hiddenField','g',23,['name':("version"),'value':(programInstance?.version)],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1463745491922L
