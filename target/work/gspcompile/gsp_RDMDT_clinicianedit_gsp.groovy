...
class gsp_RDMDT_clinicianedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/clinician/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',7,['var':("entityName"),'value':(message(code: 'clinician.label', default: 'Clinician'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('renderErrors','g',17,['bean':(clinicianInstance),'as':("list")],-1)
printHtmlPart(6)
})
invokeTag('hasErrors','g',19,['bean':(clinicianInstance)],2)
printHtmlPart(7)
createTagBody(2, {->
printHtmlPart(8)
invokeTag('hiddenField','g',22,['name':("id"),'value':(clinicianInstance?.id)],-1)
printHtmlPart(8)
invokeTag('hiddenField','g',23,['name':("version"),'value':(clinicianInstance?.version)],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1463999453616L
