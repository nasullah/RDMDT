...
class gsp_RDMDT_attachedEvidenceTypeshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/attachedEvidenceType/show.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('message','g',20,['code':("attachedEvidenceType.attachedEvidenceTypeName.label"),'default':("Attached Evidence Type Name")],-1)
printHtmlPart(5)
...
public static final long LAST_MODIFIED = 1463750071710L
