...
class gsp_RDMDT_relationshipedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/relationship/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',7,['var':("entityName"),'value':(message(code: 'relationship.label', default: 'Relationship'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('renderErrors','g',17,['bean':(relationshipInstance),'as':("list")],-1)
printHtmlPart(6)
})
invokeTag('hasErrors','g',19,['bean':(relationshipInstance)],2)
printHtmlPart(7)
createTagBody(2, {->
printHtmlPart(8)
invokeTag('hiddenField','g',22,['name':("id"),'value':(relationshipInstance?.id)],-1)
printHtmlPart(8)
invokeTag('hiddenField','g',23,['name':("version"),'value':(relationshipInstance?.version)],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1464081749013L
