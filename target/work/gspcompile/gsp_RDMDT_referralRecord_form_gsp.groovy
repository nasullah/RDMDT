...
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'otherTestingOnProband', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'pedigree', 'error'))
printHtmlPart(46)
invokeTag('message','g',344,['code':("referralRecord.pedigree.label"),'default':("Pedigree")],-1)
printHtmlPart(47)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'pedigree', 'error'))
printHtmlPart(48)
invokeTag('checkBox','bs',364,['name':("breastAndOrOvarianCancerPaternal"),'value':(referralRecordInstance?.paternal?.first()?.breastAndOrOvarianCancer),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(49)
invokeTag('checkBox','bs',373,['name':("colorectalCancerPaternal"),'value':(referralRecordInstance?.paternal?.first()?.colorectalCancer),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(50)
invokeTag('checkBox','bs',382,['name':("ischaemicHeartDiseaseOrStrokePaternal"),'value':(referralRecordInstance?.paternal?.first()?.ischaemicHeartDiseaseOrStroke),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(51)
invokeTag('checkBox','bs',391,['name':("endocrineTumoursPaternal"),'value':(referralRecordInstance?.paternal?.first()?.endocrineTumours),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(52)
invokeTag('checkBox','bs',406,['name':("breastAndOrOvarianCancerMaternal"),'value':(referralRecordInstance?.maternal?.first()?.breastAndOrOvarianCancer),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(49)
invokeTag('checkBox','bs',415,['name':("colorectalCancerMaternal"),'value':(referralRecordInstance?.maternal?.first()?.colorectalCancer),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(50)
invokeTag('checkBox','bs',424,['name':("ischaemicHeartDiseaseOrStrokeMaternal"),'value':(referralRecordInstance?.maternal?.first()?.ischaemicHeartDiseaseOrStroke),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(51)
invokeTag('checkBox','bs',433,['name':("endocrineTumoursMaternal"),'value':(referralRecordInstance?.maternal?.first()?.endocrineTumours),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(53)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'furtherDetailsOfHistory', 'error'))
printHtmlPart(54)
invokeTag('message','g',442,['code':("referralRecord.furtherDetailsOfHistory.label"),'default':("Further Details of History")],-1)
printHtmlPart(17)
invokeTag('textArea','g',444,['class':("form-control"),'name':("furtherDetailsOfHistory"),'value':(referralRecordInstance?.furtherDetailsOfHistory),'rows':("4"),'cols':("40")],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'furtherDetailsOfHistory', 'error'))
printHtmlPart(55)
invokeTag('select','g',460,['class':("form-control"),'id':("relationshipToProband1"),'name':("relationshipToProband1"),'from':(RelationshipType.list()),'optionKey':("id"),'value':(""),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(56)
invokeTag('checkBox','bs',469,['name':("availableForOAR1"),'value':(referralRecordInstance?.patients?.availableForOAR),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(57)
invokeTag('select','g',478,['class':("form-control"),'id':("ethnicity1"),'name':("ethnicity1"),'from':(rdmdt.Ethnicity.list()),'optionKey':("id"),'value':(""),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(58)
invokeTag('select','g',489,['class':("form-control"),'id':("relationshipToProband2"),'name':("relationshipToProband2"),'from':(RelationshipType.list()),'optionKey':("id"),'value':(""),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(56)
invokeTag('checkBox','bs',498,['name':("availableForOAR2"),'value':(referralRecordInstance?.patients?.availableForOAR),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(57)
invokeTag('select','g',507,['class':("form-control"),'id':("ethnicity2"),'name':("ethnicity2"),'from':(rdmdt.Ethnicity.list()),'optionKey':("id"),'value':(""),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(59)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'isAnySampleFromDeceasedIndividuals', 'error'))
printHtmlPart(60)
invokeTag('message','g',520,['code':("referralRecord.isAnySampleFromDeceasedIndividuals.label"),'default':("Is any of the samples are taken from deceased individuals")],-1)
printHtmlPart(17)
invokeTag('checkBox','bs',522,['name':("isAnySampleFromDeceasedIndividuals"),'value':(referralRecordInstance?.isAnySampleFromDeceasedIndividuals),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'isAnySampleFromDeceasedIndividuals', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'numberOfSamplesForSeq', 'error'))
printHtmlPart(61)
invokeTag('message','g',530,['code':("referralRecord.numberOfSamplesForSeq.label"),'default':("Number of samples proposed for sequencing")],-1)
printHtmlPart(17)
invokeTag('field','g',532,['class':("form-control"),'name':("numberOfSamplesForSeq"),'type':("number"),'value':(referralRecordInstance.numberOfSamplesForSeq)],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'numberOfSamplesForSeq', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'samplesForSeqDetails', 'error'))
printHtmlPart(62)
invokeTag('message','g',540,['code':("referralRecord.samplesForSeqDetails.label"),'default':("Details of samples proposed for sequencing")],-1)
printHtmlPart(17)
invokeTag('field','g',542,['class':("form-control"),'name':("samplesForSeqDetails"),'type':("text"),'value':(referralRecordInstance.samplesForSeqDetails)],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'samplesForSeqDetails', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'numberOfSampleOtherRel', 'error'))
printHtmlPart(63)
invokeTag('message','g',550,['code':("referralRecord.numberOfSampleOtherRel.label"),'default':("Number of Sample Other Relatives")],-1)
printHtmlPart(17)
invokeTag('field','g',552,['class':("form-control"),'name':("numberOfSampleOtherRel"),'type':("number"),'value':(referralRecordInstance.numberOfSampleOtherRel)],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'numberOfSampleOtherRel', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'consanguinityEvidence', 'error'))
printHtmlPart(64)
invokeTag('message','g',560,['code':("referralRecord.consanguinityEvidence.label"),'default':("Consanguinity Evidence")],-1)
printHtmlPart(17)
invokeTag('select','g',562,['class':("form-control"),'id':("consanguinityEvidence"),'name':("consanguinityEvidence.id"),'from':(rdmdt.Consanguinity.list()),'optionKey':("id"),'value':(referralRecordInstance?.consanguinityEvidence?.id),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'consanguinityEvidence', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'penetrance', 'error'))
printHtmlPart(65)
invokeTag('message','g',570,['code':("referralRecord.penetrance.label"),'default':("Penetrance")],-1)
printHtmlPart(17)
invokeTag('select','g',572,['class':("form-control"),'id':("penetrance"),'name':("penetrance.id"),'from':(rdmdt.Penetrance.list()),'optionKey':("id"),'value':(referralRecordInstance?.penetrance?.id),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'penetrance', 'error'))
printHtmlPart(66)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'referralStatus', 'error'))
printHtmlPart(67)
invokeTag('message','g',586,['code':("referralRecord.referralStatus.label"),'default':("Referral Status")],-1)
printHtmlPart(11)
invokeTag('select','g',588,['class':("form-control"),'id':("referralStatus"),'name':("referralStatus.id"),'from':(rdmdt.ReferralStatus.list().sort{it.id}),'optionKey':("id"),'required':(""),'value':(referralRecordInstance?.referralStatus?.id)],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'referralStatus', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'program', 'error'))
printHtmlPart(68)
invokeTag('message','g',596,['code':("referralRecord.program.label"),'default':("Program")],-1)
printHtmlPart(17)
invokeTag('select','g',598,['class':("form-control"),'id':("program"),'name':("program.id"),'from':(rdmdt.Program.list()),'optionKey':("id"),'value':(referralRecordInstance?.program?.id),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'program', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'note', 'error'))
printHtmlPart(69)
invokeTag('message','g',606,['code':("referralRecord.note.label"),'default':("Note")],-1)
printHtmlPart(17)
invokeTag('textArea','g',608,['class':("form-control"),'name':("note"),'value':(referralRecordInstance?.note),'rows':("4"),'cols':("40")],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'note', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'assignedTo', 'error'))
printHtmlPart(70)
invokeTag('message','g',616,['code':("referralRecord.assignedTo.label"),'default':("Assigned To")],-1)
printHtmlPart(17)
invokeTag('select','g',618,['class':("form-control"),'id':("assignedTo"),'name':("assignedTo.id"),'from':(rdmdt.Clinician.list()),'optionKey':("id"),'value':(referralRecordInstance?.assignedTo?.id),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'assignedTo', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'assignedOn', 'error'))
printHtmlPart(71)
invokeTag('message','g',626,['code':("referralRecord.assignedOn.label"),'default':("Assigned on")],-1)
printHtmlPart(17)
invokeTag('datePicker','bs',628,['name':("assignedOn"),'precision':("day"),'value':(referralRecordInstance?.assignedOn),'default':("none"),'noSelection':(['': ''])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'assignedOn', 'error'))
printHtmlPart(26)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'proposedDiagnosis', 'error'))
printHtmlPart(72)
invokeTag('message','g',638,['code':("referralRecord.proposedDiagnosis.label"),'default':("Proposed Diagnosis")],-1)
printHtmlPart(17)
invokeTag('select','g',640,['class':("form-control"),'id':("proposedDiagnosis"),'name':("proposedDiagnosis.id"),'from':(rdmdt.OMIM.list()),'optionKey':("id"),'value':(referralRecordInstance?.proposedDiagnosis?.id),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'proposedDiagnosis', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'meetingDate', 'error'))
printHtmlPart(73)
invokeTag('message','g',648,['code':("referralRecord.meetingDate.label"),'default':("Meeting Date")],-1)
printHtmlPart(17)
invokeTag('datePicker','bs',650,['name':("meetingDate"),'precision':("day"),'value':(referralRecordInstance?.meetingDate),'default':("none"),'noSelection':(['': ''])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'meetingDate', 'error'))
printHtmlPart(74)
invokeTag('field','g',662,['class':("form-control"),'name':("extraTestsRequested"),'type':("text"),'value':("")],-1)
printHtmlPart(75)
invokeTag('datePicker','bs',671,['name':("requestedDate"),'precision':("day"),'value':(""),'default':("none"),'noSelection':(['': ''])],-1)
printHtmlPart(76)
invokeTag('javascript','g',677,['plugin':("jquery"),'library':("jquery")],-1)
printHtmlPart(77)
}
