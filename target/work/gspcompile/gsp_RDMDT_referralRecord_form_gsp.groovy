...
printHtmlPart(48)
invokeTag('message','g',345,['code':("referralRecord.pedigree.label"),'default':("Pedigree")],-1)
printHtmlPart(49)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'pedigree', 'error'))
printHtmlPart(50)
}
printHtmlPart(51)
invokeTag('checkBox','bs',366,['name':("breastAndOrOvarianCancerPaternal"),'value':(referralRecordInstance?.paternal?.first()?.breastAndOrOvarianCancer),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(52)
invokeTag('checkBox','bs',375,['name':("colorectalCancerPaternal"),'value':(referralRecordInstance?.paternal?.first()?.colorectalCancer),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(53)
invokeTag('checkBox','bs',384,['name':("ischaemicHeartDiseaseOrStrokePaternal"),'value':(referralRecordInstance?.paternal?.first()?.ischaemicHeartDiseaseOrStroke),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(54)
invokeTag('checkBox','bs',393,['name':("endocrineTumoursPaternal"),'value':(referralRecordInstance?.paternal?.first()?.endocrineTumours),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(55)
invokeTag('checkBox','bs',408,['name':("breastAndOrOvarianCancerMaternal"),'value':(referralRecordInstance?.maternal?.first()?.breastAndOrOvarianCancer),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(52)
invokeTag('checkBox','bs',417,['name':("colorectalCancerMaternal"),'value':(referralRecordInstance?.maternal?.first()?.colorectalCancer),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(53)
invokeTag('checkBox','bs',426,['name':("ischaemicHeartDiseaseOrStrokeMaternal"),'value':(referralRecordInstance?.maternal?.first()?.ischaemicHeartDiseaseOrStroke),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(54)
invokeTag('checkBox','bs',435,['name':("endocrineTumoursMaternal"),'value':(referralRecordInstance?.maternal?.first()?.endocrineTumours),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(56)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'furtherDetailsOfHistory', 'error'))
printHtmlPart(57)
invokeTag('message','g',444,['code':("referralRecord.furtherDetailsOfHistory.label"),'default':("Further Details of History")],-1)
printHtmlPart(17)
invokeTag('textArea','g',446,['class':("form-control"),'name':("furtherDetailsOfHistory"),'value':(referralRecordInstance?.furtherDetailsOfHistory),'rows':("4"),'cols':("40")],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'furtherDetailsOfHistory', 'error'))
printHtmlPart(58)
invokeTag('select','g',462,['class':("form-control"),'id':("relationshipToProband1"),'name':("relationshipToProband1"),'from':(RelationshipType.list()),'optionKey':("id"),'value':(""),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(59)
invokeTag('checkBox','bs',471,['name':("availableForOAR1"),'value':(referralRecordInstance?.patients?.availableForOAR),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(60)
invokeTag('select','g',480,['class':("form-control"),'id':("ethnicity1"),'name':("ethnicity1"),'from':(rdmdt.Ethnicity.list()),'optionKey':("id"),'value':(""),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(61)
invokeTag('select','g',491,['class':("form-control"),'id':("relationshipToProband2"),'name':("relationshipToProband2"),'from':(RelationshipType.list()),'optionKey':("id"),'value':(""),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(59)
invokeTag('checkBox','bs',500,['name':("availableForOAR2"),'value':(referralRecordInstance?.patients?.availableForOAR),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(60)
invokeTag('select','g',509,['class':("form-control"),'id':("ethnicity2"),'name':("ethnicity2"),'from':(rdmdt.Ethnicity.list()),'optionKey':("id"),'value':(""),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(62)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'isAnySampleFromDeceasedIndividuals', 'error'))
printHtmlPart(63)
invokeTag('message','g',522,['code':("referralRecord.isAnySampleFromDeceasedIndividuals.label"),'default':("Is any of the samples are taken from deceased individuals")],-1)
printHtmlPart(17)
invokeTag('checkBox','bs',524,['name':("isAnySampleFromDeceasedIndividuals"),'value':(referralRecordInstance?.isAnySampleFromDeceasedIndividuals),'onLabel':("Yes"),'offLabel':("No")],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'isAnySampleFromDeceasedIndividuals', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'numberOfSamplesForSeq', 'error'))
printHtmlPart(64)
invokeTag('message','g',532,['code':("referralRecord.numberOfSamplesForSeq.label"),'default':("Number of samples proposed for sequencing")],-1)
printHtmlPart(17)
invokeTag('field','g',534,['class':("form-control"),'name':("numberOfSamplesForSeq"),'type':("number"),'value':(referralRecordInstance.numberOfSamplesForSeq)],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'numberOfSamplesForSeq', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'samplesForSeqDetails', 'error'))
printHtmlPart(65)
invokeTag('message','g',542,['code':("referralRecord.samplesForSeqDetails.label"),'default':("Details of samples proposed for sequencing")],-1)
printHtmlPart(17)
invokeTag('field','g',544,['class':("form-control"),'name':("samplesForSeqDetails"),'type':("text"),'value':(referralRecordInstance.samplesForSeqDetails)],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'samplesForSeqDetails', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'numberOfSampleOtherRel', 'error'))
printHtmlPart(66)
invokeTag('message','g',552,['code':("referralRecord.numberOfSampleOtherRel.label"),'default':("Number of Sample Other Relatives")],-1)
printHtmlPart(17)
invokeTag('field','g',554,['class':("form-control"),'name':("numberOfSampleOtherRel"),'type':("number"),'value':(referralRecordInstance.numberOfSampleOtherRel)],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'numberOfSampleOtherRel', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'consanguinityEvidence', 'error'))
printHtmlPart(67)
invokeTag('message','g',562,['code':("referralRecord.consanguinityEvidence.label"),'default':("Consanguinity Evidence")],-1)
printHtmlPart(17)
invokeTag('select','g',564,['class':("form-control"),'id':("consanguinityEvidence"),'name':("consanguinityEvidence.id"),'from':(rdmdt.Consanguinity.list()),'optionKey':("id"),'value':(referralRecordInstance?.consanguinityEvidence?.id),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'consanguinityEvidence', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'penetrance', 'error'))
printHtmlPart(68)
invokeTag('message','g',572,['code':("referralRecord.penetrance.label"),'default':("Penetrance")],-1)
printHtmlPart(17)
invokeTag('select','g',574,['class':("form-control"),'id':("penetrance"),'name':("penetrance.id"),'from':(rdmdt.Penetrance.list()),'optionKey':("id"),'value':(referralRecordInstance?.penetrance?.id),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'penetrance', 'error'))
printHtmlPart(69)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'referralStatus', 'error'))
printHtmlPart(70)
invokeTag('message','g',588,['code':("referralRecord.referralStatus.label"),'default':("Referral Status")],-1)
printHtmlPart(11)
invokeTag('select','g',590,['class':("form-control"),'id':("referralStatus"),'name':("referralStatus.id"),'from':(rdmdt.ReferralStatus.list().sort{it.id}),'optionKey':("id"),'required':(""),'value':(referralRecordInstance?.referralStatus?.id)],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'referralStatus', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'program', 'error'))
printHtmlPart(71)
invokeTag('message','g',598,['code':("referralRecord.program.label"),'default':("Program")],-1)
printHtmlPart(17)
invokeTag('select','g',600,['class':("form-control"),'id':("program"),'name':("program.id"),'from':(rdmdt.Program.list()),'optionKey':("id"),'value':(referralRecordInstance?.program?.id),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'program', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'note', 'error'))
printHtmlPart(72)
invokeTag('message','g',608,['code':("referralRecord.note.label"),'default':("Note")],-1)
printHtmlPart(17)
invokeTag('textArea','g',610,['class':("form-control"),'name':("note"),'value':(referralRecordInstance?.note),'rows':("4"),'cols':("40")],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'note', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'assignedTo', 'error'))
printHtmlPart(73)
invokeTag('message','g',618,['code':("referralRecord.assignedTo.label"),'default':("Assigned To")],-1)
printHtmlPart(17)
invokeTag('select','g',620,['class':("form-control"),'id':("assignedTo"),'name':("assignedTo.id"),'from':(rdmdt.Clinician.list()),'optionKey':("id"),'value':(referralRecordInstance?.assignedTo?.id),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'assignedTo', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'assignedOn', 'error'))
printHtmlPart(74)
invokeTag('message','g',628,['code':("referralRecord.assignedOn.label"),'default':("Assigned on")],-1)
printHtmlPart(17)
invokeTag('datePicker','bs',630,['name':("assignedOn"),'precision':("day"),'value':(referralRecordInstance?.assignedOn),'default':("none"),'noSelection':(['': ''])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'assignedOn', 'error'))
printHtmlPart(26)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'proposedDiagnosis', 'error'))
printHtmlPart(75)
invokeTag('message','g',640,['code':("referralRecord.proposedDiagnosis.label"),'default':("Proposed Diagnosis")],-1)
printHtmlPart(17)
invokeTag('select','g',642,['class':("form-control"),'id':("proposedDiagnosis"),'name':("proposedDiagnosis.id"),'from':(rdmdt.OMIM.list()),'optionKey':("id"),'value':(referralRecordInstance?.proposedDiagnosis?.id),'noSelection':(['':'- Choose -'])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'proposedDiagnosis', 'error'))
printHtmlPart(13)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'meetingDate', 'error'))
printHtmlPart(76)
invokeTag('message','g',650,['code':("referralRecord.meetingDate.label"),'default':("Meeting Date")],-1)
printHtmlPart(17)
invokeTag('datePicker','bs',652,['name':("meetingDate"),'precision':("day"),'value':(referralRecordInstance?.meetingDate),'default':("none"),'noSelection':(['': ''])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: referralRecordInstance, field: 'meetingDate', 'error'))
printHtmlPart(77)
invokeTag('field','g',664,['class':("form-control"),'name':("extraTestsRequested"),'type':("text"),'value':("")],-1)
printHtmlPart(78)
invokeTag('datePicker','bs',673,['name':("requestedDate"),'precision':("day"),'value':(""),'default':("none"),'noSelection':(['': ''])],-1)
printHtmlPart(79)
invokeTag('javascript','g',679,['plugin':("jquery"),'library':("jquery")],-1)
printHtmlPart(80)
}
...
public static final long LAST_MODIFIED = 1464253657610L
