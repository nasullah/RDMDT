...
class gsp_RDMDT_referralRecordindex_gsp extends GroovyPage {
...
printHtmlPart(13)
invokeTag('paginate','g',43,['total':(referralRecordInstanceTotal == null ? ReferralRecord.count(): referralRecordInstanceTotal),'params':(filterParams)],-1)
printHtmlPart(14)
...
public static final long LAST_MODIFIED = 1464795846291L
